...
%>
	...
	<div id="id03" class="modal">
		...
		<form class="modal-content animate" action="CreateReview_Action.jsp"
			method="post">
			...
			<div class="container">
				<label for="food_item"><b>Food Item</b></label> <input type="text"
					placeholder="Food Item" name="food_item" value="<%=foodItem%>"
					readonly> <label for="title"><b>Title</b></label> <input
					type="text" placeholder="Enter Title" name="title" required>

				<label for="desc"><b>Description</b></label> <input type="text"
					placeholder="Enter Description" name="desc" required> <label
					for="rating"><b>Rating</b></label> <input type="number"
					placeholder="Enter Rating" min="1" max="5" name="rating" required>
...
if(session.getAttribute("loggedInUser") != null)
{
	...
	<button onclick="document.getElementById('id03').style.display='block'"
		style="width: auto;">Make Review</button>
	<%
	}
